...
# 
# #progress_bar_value = str(main.compress_progress) + '%'
# #print(main.compress_progress)
# 
# ### end tmp
# 
...
#     $.ajax({
#       url: "http://127.0.0.1:5000/static/progress_file.txt",
#       success: function(data){
#         console.log(data);
#       }
#     });
#     // $.get('http://127.0.0.1:5000/static/progress_file.txt',{ "_": $.now() }, function(data){
#     //   console.log(data);
#     // });
# }, 2000);